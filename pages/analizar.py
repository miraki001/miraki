...
for index in range(len(df)) :
   ...
   st.session_state['vfuente'] = df3.to_string(columns=['fuente'], header=False, index=False)
   st.session_state['vdescrip'] = df3.to_string(columns=['descrip'], header=False, index=False)
