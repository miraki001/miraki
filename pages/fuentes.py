...
if selected4=="Verificar":
    st.switch_page("./pages/verificar_new.py") 
...
if cnt>0:
  ...
  st.session_state['vposlink'] = df3.to_string(columns=['poslink'], header=False, index=False)
